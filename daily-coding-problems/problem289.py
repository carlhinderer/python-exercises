...
#   a single pile. The player who eventually is forced to take the last stone loses. 
#   For example, if the initial heap sizes are 3, 4, and 5, a game could be played as 
#   shown below:
#
#    A  |  B  |  C
#  -----------------
...
#
# Given a list of non-zero starting values [a, b, c], and assuming optimal play, determine 
#   whether the first player has a forced win.
#