...
#   paths between some of these locations to their corresponding distances, find the 
#   length of the shortest route satisfying the condition above. Assume the runner's home 
#   is location 0.
#
