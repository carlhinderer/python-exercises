...
#   adjacency list. For example, the following descibes a situation where 0 is friends with 
...
#   no student in the group has any friends outside this group. For the example above, the 
#   friend groups would be {0, 1, 2, 5}, {3, 6}, {4}.
#
# Given a friendship list such as the one above, determine the number of friend groups in the 
#   class.
#