...
#   secret code of the second. In this version, the code may be any six-digit 
...
#   the secret code 123456:
#
# {175286: 2, 293416: 3, 654321: 0}
#
# However, it is impossible for any key to result in the following scores, so in this case 
