...
#   value as the number of most frequently-occurring letter along that path. For 
#   example, if a path in the graph goes through "ABACA", the value of the path is 3, 
...
#   the uppercase letter of the i-th node. Each tuple in the edge list (i, j) means 
#   there is a directed edge from the i-th node to the j-th node. Self-edges are possible,
