...
#   cells. Each cell is either dead or alive, and at each tick, the following rules apply:
#
...
#   it should print out the board state at each step. Since it's an infinite board, print 
#   out only the relevant coordinates, i.e. from the top-leftmost live cell to 
