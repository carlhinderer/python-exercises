...
#   While there have been changes over the years, the central idea is to assign each 
#   site a score based on the importance of other pages that link to that page.
#
